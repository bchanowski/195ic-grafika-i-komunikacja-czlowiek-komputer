...
namespace SortVisual
{
    class SortBubble : Sort
    {
        ...
        private void Swap(int i, int v)
        {
            ...
            g.FillRectangle(WhiteBrush, i, 0, 1, MaxVal);
            g.FillRectangle(WhiteBrush, v, 0, 1, MaxVal);

            g.FillRectangle(BlackBrush, i, MaxVal - TheArray[i], 1, MaxVal);
            g.FillRectangle(BlackBrush, v, MaxVal - TheArray[v], 1, MaxVal);
        }
